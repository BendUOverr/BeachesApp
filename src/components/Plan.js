  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        <h3 className="text-5xl md:text-6xl font-bold italic">Plan Your Next Trip</h3>
        <p className="text-2xl py-6">dsadsad sfgfgsdfd sdasdasd asd adsa dasd ad adas</p>
        <p className="pb-6">dsfsdfsd dfdsdsgfdsf dfdsfdsfdsf dsfdsfdsfdsf</p>
        <div>
